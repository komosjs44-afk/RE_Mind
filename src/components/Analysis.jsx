import WeeklyConditionStory from './analysis/WeeklyConditionStory';
import DailyPlanDiagnosis from './analysis/DailyPlanDiagnosis';
import DataImpactRanking from './analysis/DataImpactRanking';
import NextWeekSimulation from './analysis/NextWeekSimulation';
import RecommendedActionCTA from './analysis/RecommendedActionCTA';

export default function Analysis({ overload, dataSources, recommendations, dailyPlan = [], health, onGoHome }) {
  return (
    <main className="page no-scrollbar h-[calc(100%-112px)] overflow-y-auto pb-24">
      ...
      />
      <DataImpactRanking dataSources={dataSources} />
      <NextWeekSimulation prediction={overload} />
      <RecommendedActionCTA interventions={recommendations} onGoHome={onGoHome} />
    </main>
  );
}
